...
def process_event(
    ...
    if analysis_file.exists():
        ...
        try:
            ...
            # ------------------------------------------------------
            # Existing Analysis must contain Event ID
            # ------------------------------------------------------
            ...
            # ------------------------------------------------------
            # Determine which catalog Skills are actually declared
            #
            # 这里不调用 Router。
            #
            # 直接从已有 Analysis 的 Selected Skills 区块读取。
            # ------------------------------------------------------
            ...
            # ------------------------------------------------------
            # Existing Analysis must have exactly valid skill count
            # ------------------------------------------------------
            ...
            # ------------------------------------------------------
            # Make sure the Selected Skills section actually contains
            # explicit skill filenames.
            # ------------------------------------------------------
            ...
            # ------------------------------------------------------
            # Existing file exists but is invalid.
            #
            # 不删除旧文件。
            # 进入下面正常的 Router → Analysis 流程。
            # ------------------------------------------------------
    ...
    # ==============================================================
    # ANALYSIS GENERATION + VALIDATION RETRY
    #
    # Router 已经完成。
    #
    # selected_skills 永远固定。
    #
    # Retry：
    #
    # ❌ 不重新 Router
