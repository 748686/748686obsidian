...
def language_dir(date, language=None):
    ...
    因此任何大写语言值都会在 normalize_language()
    阶段直接失败，而不会被自动修正。
    """
...
# ======================================================================
# VALIDATE GLOBAL CLUSTER MEMBERSHIP
# ======================================================================
...
def load_merged_clusters(
    ...
    if saved_language != language:
        ...
        log_conflict(
            date,
            "TASK 2 SAVED LANGUAGE",
            "已保存merged_clusters语言大小写不符合契约。",
            {
                "expected":
                    language,
