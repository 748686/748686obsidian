...
def call_ai_json(
    ...
    for attempt in range(
        ...
        try:
            ...
            # API / 网络等错误
            #
            # call_ai 自己已经进行了 HTTP retry。
            # 如果最终仍失败，这里再进入 JSON 总循环。
            # ------------------------------------------------------
...
def main():
    ...
    print(
        "748686 KNOWLEDGE ASSET COMPILER V2.1"
    )
