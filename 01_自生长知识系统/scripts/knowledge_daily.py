...
重要：
    ...
    历史数据获取 / Horizon / Atomic / Enriched
    的重试由外层 Workflow / Acquisition Layer 负责。
...
def process_three_dates(
    ...
    print(
        f"  2. YESTERDAY   : {yesterday}"
    )
    print(
        f"  3. DAY-BEFORE  : {day_before}"
    )
    print(
        "#" * 70
    )
    ...
    # ==============================================================
    # Date transaction state
    # ==============================================================

    results: dict[str, str] = {}

    # ==============================================================
    # Process TODAY → YESTERDAY → DAY-BEFORE
    # ==============================================================
    ...
    for index, (
        ...
        try:
            ...
            print(
                "   Historical failure does not "
                "terminate Daily pipeline."
            )
            print(
    ...
    print(
        "KNOWLEDGE DAILY — DATE TRANSACTION SUMMARY"
    )
    print(
        "#" * 70
    )
    ...
    print(
        f"TODAY       : "
        f"{today} | {results.get('today', 'FAILED')}"
    )

    print(
        f"YESTERDAY   : "
        f"{yesterday} | {results.get('yesterday', 'NOT_PROCESSED')}"
    )

    print(
        f"DAY-BEFORE  : "
        f"{day_before} | {results.get('day-before', 'NOT_PROCESSED')}"
    )
    ...
    if results.get(
        ...
        raise RuntimeError(
            "TODAY daily report did not complete successfully."
        )

    print()
    print(
        "✅ KNOWLEDGE DAILY V4.1 COMPLETE"
    )
    print(
        "TODAY completed successfully."
    )
    print(
        "Historical dates may be SKIPPED "
