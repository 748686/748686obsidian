...
def global_cluster_registry_path(date):
    return event_units_dir(date) / GLOBAL_CLUSTER_REGISTRY_FILE
...
def run_stage_1(date):
    ...
    validate_final_event_ids(date, events)
