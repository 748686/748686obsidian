...
1. Git LFS 职责移交给 GitHub Actions。
...
2. 增加真实模型文件检查。
   ...
   则明确判定为 Git LFS pointer，
   而不是正常模型文件。

3. Kokoro 使用官方已验证 API：
